						...
						<div class="card-body">
							<form method="post" action="modifierCategorie">
								...
								<div class="form-group">
									<input type="hidden" name="codeCategorie" value="${categorie.code }"> 
									<input type="text" class="form-control"
										placeholder="Category Name" name="libelle"
										value="<%=categorie.getLibelle()%>">
								</div>
								<div class="form-group">
									<select name="codeProduit" id="produit">
										<option value="-1">Product Choice</option>
										<%
										for (Produit sp : produits) {
										%>
										<option value="<%=sp.getCode()%>"
											<%if (sp.getCode().equals(categorie.getProduit().getCode())) {%>
											selected=selected <%}%>><%=sp.getLibelle()%>
										</option>
										<%
										}
										%>
								...
								<div class="form-group row">
									<div class="col-sm-10">
										...
										<a href="categories" class="btn btn-danger"> <i
